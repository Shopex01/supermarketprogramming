...
public class GUI extends JFrame{
	...
	public GUI() {
		...
		JTextArea textArea_2 = new JTextArea(backend.status_warenkorbliste);
		...
		JList<String> list_1 = new JList<>(backend.getModel()); //Warenkorb-Liste Tab
		backend.getModel().addElement(DefaultCart.getListName()); //Default Cart einfügen
		...
		JTextArea textArea_2_1 = new JTextArea(backend.status_warenkorb);
